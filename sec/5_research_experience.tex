...
\begin{rSection}{Research Experience}
     ...
     \small{{\bf LLM Lineage Tracing via Spectral Fingerprints}  \hfill Nov. 2025 - Mar. 2026
    \\ Supervisor: \href{https://lsjxjtu.github.io/index.html}{\textcolor{BS_color}{Prof. Sijia Liu}} (MSU)
\vspace{-1.5mm}
    
    \quad $\bullet$ Proposed a data-free framework to trace LLM lineage from \textbf{weight geometry} alone, without access to training data or model inputs.
\vspace{-2mm}
    
    \quad $\bullet$ Showed that spectral energy separates independently trained model families, while subspace alignment discriminates models built on a shared base, across \textbf{110+} open-weight model pairs.
\vspace{-2mm}
...
\vspace{-2mm}
    ...
    \quad $\bullet$ \textbf{Publication}: \pubcite{3}.
