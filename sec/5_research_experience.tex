...
\vspace{-1.5mm}
    ...
    \quad $\bullet$ Proposed a data-free method to trace LLM lineage from \textbf{weight geometry} alone, without any model inputs.
\vspace{-2mm}
    
    \quad $\bullet$ Spectral energy separates model families; subspace alignment detects shared bases across \textbf{110+} model pairs.
\vspace{-2mm}
